...
# Wifi Cracker By Mr.Alex Warning i'm not responsible for hacking Wifi or etc This Soft is For Ethical Hackers Hacking is Prohibited By Law
...
### Kali Linux / Ubuntu / Parrot OS,Ubuntu 16,04

```bash
1) sudo apt-get update && apt-get install git
2) sudo git clone https://github.com/mralexrusoff/Wifi-Cracker
3) cd Wifi-Hacking/
...
(Mr.Alex) Hey, Dont Forget To say Thanks me :smile:
...
### - [TG](https://www.t.me/mralex_rus/)
<a href="http://mr-alex.ga" target="_blank">Visit Our Website</a>
